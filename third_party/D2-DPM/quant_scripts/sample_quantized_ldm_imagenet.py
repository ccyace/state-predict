...
if __name__ == '__main__':
    ...
    ckpt = torch.load('scale3.0_eta0.0_step20/imagenet/w4a8/weights/quantw{}a{}_ldm_brecq_1000classes.pth'.format(n_bits_w, n_bits_a), map_location='cpu')
    ...
    image_to_save.save("scale{}_eta{}_step{}/imagenet/w{}a{}/save_data/cwi_correct_step30.png".format(scale, ddim_eta, ddim_steps, n_bits_w, n_bits_a))